...
err.accRate.acc  <- cbind(c(perc.accRate[1,1:16],NA, perc.accRate[1,17:32]),
                          c(perc.accRate[2,1:16],NA, perc.accRate[2,17:32]))
err.accRate.spd  <- cbind(c(perc.accRate[1,33:48],NA, perc.accRate[1,49:64]),
                          c(perc.accRate[2,33:48],NA, perc.accRate[2,49:64]))
# Mean RT-correct
...
err.rtCorMean.acc  <- cbind(c(perc.rtCorMean[1,1:16],NA, perc.rtCorMean[1,17:32]),
                            c(perc.rtCorMean[2,1:16],NA, perc.rtCorMean[2,17:32]))
err.rtCorMean.spd  <- cbind(c(perc.rtCorMean[1,33:48],NA, perc.rtCorMean[1,49:64]),
                            c(perc.rtCorMean[2,33:48],NA, perc.rtCorMean[2,49:64]))
# RT-correct Variance
est.rtCorVar.acc <- c(est.rtCorVar[1:16],NA,est.rtCorVar[17:32])
est.rtCorVar.spd <- c(est.rtCorVar[33:48],NA,est.rtCorVar[49:64])
err.rtCorVar.acc  <- cbind(c(perc.rtCorVar[1,1:16],NA, perc.rtCorVar[1,17:32]),
                           c(perc.rtCorVar[2,1:16],NA, perc.rtCorVar[2,17:32]))
err.rtCorVar.spd  <- cbind(c(perc.rtCorVar[1,33:48],NA, perc.rtCorVar[1,49:64]),
                           c(perc.rtCorVar[2,33:48],NA, perc.rtCorVar[2,49:64]))
```
...
arrows(fit_x,err.accRate.acc[,1], fit_x, err.accRate.acc[,2], length=0.05, angle=90, code=3, col=error.color)
points(fit_x, est.accRate.acc, col=error.color, pch=16, cex=0.7)
axis(1,c(-2,0,2),c("More black pixels","50/50","More white pixels"), line = 0.1, col.ticks = "white", col="white")
axis(1,c(-4,-2,0,2,4),c("","","","",""), line=0)
...
arrows(fit_x,err.accRate.spd[,1], fit_x, err.accRate.spd[,2], length=0.05, angle=90, code=3, col=error.color)
points(fit_x, est.accRate.spd, col=error.color, pch=16, cex=0.7)
axis(1,c(-2,0,2),c("More black pixels","50/50","More white pixels"), line = 0.1, col.ticks = "white", col="white")
axis(1,c(-4,-2,0,2,4),c("","","","",""), line=0)
axis(2,seq(0,1,0.2),seq(0,1,0.2), las=2)
