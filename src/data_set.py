...
#  Note: This code contains unfinished experimental parts that are
#  untested beyond its use in published papers.
...
class Hddm_Data():
    def __init__(self, person = None, rt = None, accuracy = None,
                       n_TrialsPerPerson = None, X = None):
        self.person            = person
        self.rt                = rt
    ...
    def sample(design):
        ...
        for p in range(P):
            accuracy = 0
            rt, accuracy = wdmrnd(parameters.bound[p],
                                  parameters.drift[p],
                                  parameters.nondt[p], T)
    ...
    def summary(self):
        ...
        print("{:<10} {:<20} {:<20} {:<20}".format("Person",
                                                   "Mean Accuracy",
                                                   "Mean RT (Correct)",
                                                   "Variance RT (Correct)"))
        ...
        for person_id in unique_persons:
            ...
            correct_rts         = person_rts[person_accuracy == 1]
            ...
            print("{:<10} {:<20.3f} {:<20.3f} {:<20.3f}".format(person_id,
                                                                mean_accuracy,
                                                                mean_rt_correct,
                                                                variance_rt_correct))
